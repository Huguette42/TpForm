...
<form class="d-flex justify-content-center" action="{{ route('contracts.update', ['id' => $contract->id]) }}" method="POST">
    ...
    {{--
        Edition du contrat avec pour chaque information un label et un champ
    --}}
    ...
    <div class="w-75 maindiv">
        ...
        {{--
            Genere les champ d'information des partenaire en fonction de ceux inclut dans le contrat
        --}}
        ...
        {{--
            Suite des champs du formulaire
        --}}
