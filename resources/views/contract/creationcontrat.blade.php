...
@section('content')
    <div class="main-block w-100 d-flex justify-content-center align-items-center py-4">
        ...
        <form id="mainForm" class="form-contrat d-flex justify-content-center align-items-center flex-column" action="{{ route('contracts.store') }}" method="POST">
            @csrf
            ...
            <div id="step1" class="">
                ...
                <div id="partenaire" class="d-flex flex-wrap justify-content-center w-100 align-items-center flex-row">
                    ...
                    {{--
                        Generation des champs pour chaque partenaire

                        Les champs sont desactivés car le choix des partenaires est définitif
                    --}}
            ...
            {{--
                Generation des champs de contribution pour chaque partenaire
            --}}
            ...
            <div id="step4" class="d-none">
                ...
                {{--
                    Génération des options pour le nombre de signatures minimales
                --}}
            ...
            <div id="step5" class="d-none">
                ...
                <input class="form-control" type="text" name="duree"><br>
            ...
            <div class="d-flex justify-content-center align-items-center">
                ...
                <button id="buttonprev" class="btn btn-arrow m-2" type="button" onclick="previousStep()">Précédent</button>

                {{--
                    Bouton d'étapes suivantes qui se change en bouton de validation à la dernière étape
                --}}
